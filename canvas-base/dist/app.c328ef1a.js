...
function testPath2D() {
  ...
  context.scale(scale, scale); // A square

  var path1 = new Path2D();
  path1.rect(105, 105, 90, 90); // A rounded rectangle
  ...
  context.fill(path1);
  context.fill(path2); // Add hit testing for the shapes tht have been drawn
...
init();
},{"./app.css":"app.css","lodash":"../node_modules/lodash/lodash.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
